...
from pyjy.central_controller import CentralController
...
def main():
    ...
    while running:
        time_delta = clock.tick(GameConfig.FPS) / 1000.0
        ...
        central_controller.update(time_delta)
        
        central_controller.draw(time_delta)
